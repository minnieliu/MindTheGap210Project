...
public class ArrivalBoardListFragment extends ListFragment {
     ...
     */
    public static ArrayList<ArrivalBoard> getArrivalBoardsForSelectedStation() {
        ...
        if (selectedStation != null) {
          Iterator<ArrivalBoard> iterableArrivalBoards = selectedStation.iterator();
            if (iterableArrivalBoards != null) {
                while (iterableArrivalBoards.hasNext()) {
                    boards.add(iterableArrivalBoards.next());
                }
            }
        }
        return boards;
